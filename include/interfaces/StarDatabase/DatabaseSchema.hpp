// generated by sqlite2cpp.py ../../../database/celestial_body_tables.sql ../../../include/DatabaseSchema.h StarDatabaseSchema
...
namespace StarDatabaseSchema
{
  ...
  namespace Ephemeris_
  {
    ...
    struct GpsLong
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "gpsLong";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T gpsLong;
            T& operator()() { return gpsLong; }
            const T& operator()() const { return gpsLong; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::floating_point, sqlpp::tag::require_insert>;
    };
    struct GpsLat
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "gpsLat";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T gpsLat;
            T& operator()() { return gpsLat; }
            const T& operator()() const { return gpsLat; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::floating_point, sqlpp::tag::require_insert>;
    };
    struct GpsElev
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "gpsElev";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T gpsElev;
            T& operator()() { return gpsElev; }
            const T& operator()() const { return gpsElev; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::floating_point, sqlpp::tag::require_insert>;
    };
